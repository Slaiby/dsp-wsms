...
df.to_csv(os.getcwd() + '/data-ingestion/simulated_loan_data.csv', index=False)

print("Simulated dataset created with 10k rows and saved as 'simulated_loan_data.csv'.")
